...
public  class SystemLogAspect {    
	...
	//Service层切点    
	@Pointcut("@annotation(com.project.application.config.SystemServiceLog)")    
	public  void serviceAspect() {    
	}    

	//Controller层切点    
	@Pointcut("@annotation(com.project.application.config.SystemControllerLog)")    
	...
	public  void doBefore(JoinPoint joinPoint) {    
		...
		try {    
			...
			System.out.println("请求人:" + admin.getAdName());    
			...
			log.setLgCreateUser(admin.getAdId());    
