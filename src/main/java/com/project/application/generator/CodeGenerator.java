package com.project.application.generator;
...
import com.project.application.core.ProjectConstant;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://rm-uf6c3bc6ei4c8sxp6o.mysql.rds.aliyuncs.com:3306/db_project";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "@sqf519205";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";

    private static final String PROJECT_PATH = System.getProperty("user.dir");//项目在硬盘上的基础路径
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/src/main/java/com/project/application/generator/template";//模板位置
